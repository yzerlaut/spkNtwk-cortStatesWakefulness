...
# -------------------------------
# ==> Exc
# Model['p_Exc_Exc'] = 0.05
Model['p_Exc_PvInh'] = 0.05
Model['p_Exc_SstInh'] = 0.05
# ==> oscillExc
...
Model['p_PvInh_Exc'] = 0.2
Model['p_PvInh_oscillExc'] = 0.2
# ==> SstInh
# Model['p_SstInh_Exc'] = 0.05
# Model['p_SstInh_PvInh'] = 0.05
Model['p_SstInh_oscillExc'] = 0.05
# ==> VipInh
Model['p_VipInh_SstInh'] = 0.2
Model['p_VipInh_PvInh'] = 0.2
Model['p_VipInh_oscillExc'] = 0.1
# ==> AffExc
Model['p_AffExc_VipInh'] = 0.2
Model['p_AffExc_PvInh'] = 0.2
Model['p_AffExc_Exc'] = 0.02
...
if sys.argv[-1]=='plot':
    ...
    faff = np.array([2*int(tt/1000) for tt in t])
