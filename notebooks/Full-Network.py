...
Model = {
    ...
    'p_TcExc_L5Exc':0.05, 'p_TcExc_ReInh':0.05, 'p_TcExc_L4Exc':0.025, 'p_TcExc_L4Inh':0.05, 
    'p_L5Exc_TcExc':0.01, 
    'p_L4Exc_L23Exc':0.025, 'p_L4Exc_L4Inh':0.025, 
    'p_L4Inh_L4Exc':0.05, 
    'p_ReInh_ReInh':0.08, 'p_ReInh_TcExc':0.08, 
    'p_BgExc_TcExc':0.1, 
    'p_ModExc_TcExc':0.15, 'p_ModExc_ReInh':0.3, 'p_ModExc_L5Inh':0.2, 
    ...
    'L5Inh_a':0., 'L5Inh_b': 0, 'L5Inh_tauw':1e5,
    # --> Layer 4 cortical population (Exc)
    ...
    #
    'REC_POPS':['TcExc', 'ReInh', 'L5Exc', 'L5Inh', 'L4Exc', 'L4Inh', 'L23Exc'],
