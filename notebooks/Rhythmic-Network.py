...
Model = {
    ...
    'L4Exc_a':0., 'L4Exc_b': 0, 'L4Exc_tauw':200.,
    ...
    'L23Exc_a':0., 'L23Exc_b': 80, 'L23Exc_tauw':200.,
    #
    'REC_POPS':['TcExc', 'ReInh', 'L5Exc', 'L5Inh', 'L4Exc'],
    'AFF_POPS':['BgExc', 'ModExc'],
    # External drives
    'F_BgExc':8.,
    # connectivity parameters: recurrent populations
    'p_TcExc_L5Exc':0.05, 'p_TcExc_ReInh':0.05, 'p_TcExc_L4Exc':0.05, 'p_TcExc_L4Inh':0.05, 
    'p_ReInh_ReInh':0.05, 'p_ReInh_TcExc':0.2, 
    'p_L5Exc_TcExc':0.025, 'p_L5Exc_L5Exc':0.05, 'p_L5Exc_L5Inh':0.05, 
    'p_L4Exc_L4Inh':0.025, 'p_L4Exc_L23Exc':0.025, 
    'p_L4Inh_L4Exc':0.05, 
    # connectivity parameters: afferent populations
    'p_BgExc_TcExc':0.1, 
    'p_ModExc_TcExc':0.2, 'p_ModExc_ReInh':0.3, 'p_ModExc_L5Inh':0.2, 
}
